...
Approved namespaces. Version 1.7 adds the natural-science namespaces `biome`, `ecology`, `geology`, `hydrology`, and `landform`; `marine` remains distinct from the historical/archaeological `maritime` namespace:
